...
setup(
    ...
    entry_points={
        ...
        'cliff.bitbucket': [
            ...
            'group-create = bitbucket.groups:Creategroup',
            'group-delete = bitbucket.groups:Deletegroup',
            'group-members = bitbucket.groups:Groupmembers',
            'group-member-add = bitbucket.groups:Addgroupmember',
            'group-member-delete = bitbucket.groups:Deletegroupmember',
            ...
            'repo-share = bitbucket.repository:Reposhareget',
            'repo-share-with = bitbucket.repository:Reposharepost',
            'repo-share-remove = bitbucket.repository:Reposharedelete',
            'sshkey = bitbucket.ssh:Sshkeyget',
            'sshkey-add = bitbucket.ssh:Sshkeypost',
            'sshkey-delete = bitbucket.ssh:Sshkeydelete',
